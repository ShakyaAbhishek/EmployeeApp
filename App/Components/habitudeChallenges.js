...
class HabitudeChallenge extends Component {
  constructor(props) {
    super(props);
    this.state = {
      challengeBool: true
    ...
    return (
      <ImageBackground source={backgroundImage} style={styles.bgImage}>
        <SafeAreaView style={styles.safeAreaViewContainer}>
          ...
          <View>
            <HeaderBack {...this.props} heading="Habitude Challenges" />
          </View>
                ...
                >
                  <ScrollView showsVerticalScrollIndicator={false}>
                    {this.state.challengeBool ? (
                      <HabtitudeActiveChallenges {...this.props} />
                    ) : (
                        <HabitudeMyChallenges {...this.props} />
                      )}
                  </ScrollView>
                </View>
              </View>
