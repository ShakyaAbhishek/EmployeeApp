    ...
    render() {
        ...
        const arcs = pieSlices.map((slice, index) => (
            index === 0 ?
            {
                ...
                ...slice,
                path: shape.arc()
                    .outerRadius(outerDiameter / 2.2)  // Radius of the pie
                    .innerRadius((outerDiameter / 2.2) - strokeWidth)  // Inner radius: to create a donut or pie
                ...
                ...slice,
                path: shape.arc()
                    .outerRadius(outerDiameter / 2.5)  // Radius of the pie
